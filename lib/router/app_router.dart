  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    switch (name) {
      ...
      case AppRoutes.login:
        return _page<bool>(settings, (_) => const LoginScreen(),
            fullscreenDialog: true);
      case AppRoutes.loginEmail:
        return _page<bool>(settings, (_) => const EmailLoginScreen(),
            fullscreenDialog: true);
      case AppRoutes.signup:
        return _page<bool>(settings, (_) => const SignUpScreen(),
            fullscreenDialog: true);
      ...
      case AppRoutes.userResultDetail:
        {
          ...
          if (args is! UserResultDetailArgs) {
            return _error(
                settings, 'missing args for ${AppRoutes.userResultDetail}');
          }
          return _page(
            settings,
      ...
      case AppRoutes.userResultSingle:
        {
          ...
          if (args is! UserResultDetailArgs) {
            return _error(
                settings, 'missing args for ${AppRoutes.userResultSingle}');
          }
          return _page(
            settings,
      ...
      case AppRoutes.interpretation:
        {
          final args = settings.arguments;
          final resolved =
              args is InterpretationArgs ? args : const InterpretationArgs();
          return _page(
            settings,
      ...
      case AppRoutes.interpretationRecordDetail:
        {
          ...
          if (args is! InterpretationRecordDetailArgs) {
            return _error(settings,
                'missing args for ${AppRoutes.interpretationRecordDetail}');
          }
          return _page(
            settings,
      ...
      case AppRoutes.resultSummary:
        {
          ...
          if (args is! ResultSummaryArgs) {
            return _error(
                settings, 'missing args for ${AppRoutes.resultSummary}');
          }
          return _page(
              settings, (_) => ResultSummaryScreen(result: args.result));
        }
      case AppRoutes.existenceDetail:
        {
          ...
          if (args is! ExistenceDetailArgs) {
            return _error(
                settings, 'missing args for ${AppRoutes.existenceDetail}');
          }
          return _page(
              settings, (_) => ExistenceDetailScreen(result: args.result));
        }
      case AppRoutes.rawResult:
        {
          ...
          return _page(settings,
              (_) => RawResultScreen(title: args.title, payload: args.payload));
        }
      case AppRoutes.testNote:
        {
          ...
          return _page(
              settings,
              (_) => TestNoteScreen(
                  testId: args.testId, testTitle: args.testTitle));
        }
      case AppRoutes.wpiSelectionFlow:
        {
          final args = settings.arguments;
          if (args is! WpiSelectionFlowArgs) {
            return _error<FlowCompletion>(
                settings, 'missing args for ${AppRoutes.wpiSelectionFlow}');
          }
